...
// 异步加载
/*eslint-disable*/
import loadFrom from 'bundle-loader?lazy!../Component/From'; // 表单组件//【lazy component】
...
import loadbabylon from 'bundle-loader?lazy!../Containers/babylonContainer'; // 
import loadTodoList from 'bundle-loader?lazy!../Containers/TodoListContainer'; // TodoList组件
/* eslint-enable */

// components load their module for initial visit
// //这里只是给this.props.child传一个方法，最后在Bundle的render里面调用
const createComponent = component => props => (//【bundle component】
  ...
  <Router>
    <div className="app">
      <Switch>
        ...
        <Route path="/babylon" component={createComponent(loadbabylon)} />
